...
public class CrawlerSendsIncompleteness implements Event {
	private int messageType; //message type 1 - 12
	private int crawlerId; //crawler id
	private Protocol t = Protocol.CRAWLER_SENDS_INCOMPLETENESS; //able to identify type of event

	public CrawlerSendsIncompleteness(byte[] data) {
	...
	public CrawlerSendsIncompleteness(int node) {
		messageType = 2;
		crawlerId = node;
	}
